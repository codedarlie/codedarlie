...
#### [Бот-расписание](https://github.com/codedarlie/vk-homework-bot)
![2021](https://img.shields.io/badge/2021-red.svg)
![Python](https://img.shields.io/badge/Python-3776AB?logo=python&logoColor=white)
![SQLite](https://img.shields.io/badge/SQLite-003B57?logo=sqlite&logoColor=white)
![VK API](https://img.shields.io/badge/VK_API-0077ff?logo=vk&logoColor=white)

Бот для ведения расписания и домашних заданий в беседах ВКонтакте.  
Поддержка расписания, ДЗ, заметок, личных кабинетов, кнопок и каруселей.

Первый проект, написанный в годы карантина для автоматизации учёбы учеников. 
**Ужасный код, странные решения, но большой энтузиазм и сильное желание помочь людям.**
